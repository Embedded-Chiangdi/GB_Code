...
#define CONFIG_GATE_PATH "/config/gate_config.txt"
...
float get_disk_rate();
int read_config_gate(float *gate_mem,float *gate_disk);
...
int main(int argc,char *argv[])
{
    ...
    read_config_gate(&g_info.value_mem,&g_info.value_disk);
...
int read_config_gate(float *gate_mem,float *gate_disk){
    ...
    fscanf(f1,"%f %f",gate_mem,gate_disk);
